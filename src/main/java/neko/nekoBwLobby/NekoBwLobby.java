...
import neko.nekoBwLobby.listeners.InteractiveTopClickListener;
...
public final class NekoBwLobby extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getCommand("addinteractivetop").setExecutor(new AddInteractiveTopCommand(this, databaseManager));

        // 注册监听器
        Bukkit.getPluginManager().registerEvents(new InteractiveTopClickListener(this), this);
